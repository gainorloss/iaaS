...
namespace Dev.Entities
{
    ...
    public partial class Order
    {
        ...
        // 2018.11.30
        //弃用:  public string BatchNumber { get; set; }
        //弃用:  public int InvoiceKind { get; set; }
        //弃用:  public DateTime? ShopMsgDate { get; set; }
        // 2018.10.14
        //弃用:  public string ExpNumber { get; set; } 
        //弃用:  public string SoldType { get; set; }
        //弃用:  public string WebOrderID { get; set; } // 订单号
        //弃用:  public int ShippingType { get; set; }
        //弃用:  public int IsLock { get; set; }
        //弃用:  public string ShippingMessage{ get; set; }
    }
}
